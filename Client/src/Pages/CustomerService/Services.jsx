        ...
        <Box className="boxforall">
          <Box className="box_one">
            ...
            <Box className="about_it">
              <p>
                Every test booked via CureCart is conducted by certified labs
          ...
          <Box className="box_one">
            ...
            <Box className="about_it">
              <p>
                With CureCart, you get a FREE sample pick-up* by professional
          ...
          <Box className="box_one">
            ...
            <Box className="about_it">
              <p>
                At CureCart, you save at every step! On diagnostic tests, get
