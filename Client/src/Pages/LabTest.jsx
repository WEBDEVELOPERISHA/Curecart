          ...
          <Box className="partnerlabsdiv">
            <Link to="/labdetails" className="covidrtpcr">
              <img
                ...
                alt="full body checkup"
              />
              <p className="rtpcr">CureCart Labs (Covid RTPCR)</p>
            ...
            <Link to={"/labdetails"} className="covidrtpcr">
              ...
              <p className="rtpcr">CureCart Labs (Thyrocare powered)</p>
        ...
        <Box className="lab_test_online_div">
          ...
          <Box className="booking_made_simple">
            ...
            <Box className="span_box">
              <span>
                One of the most popular services CureCart offers is diagnostic
            ...
            <Box className="secondparadiv">
              <span className="secondspan">
                To bypass these hassles, CureCart has set up an extensive
          ...
          <Box className="thirdparadiv">
            ...
            <Box className="doorstep">
              <span className="thirdspan">
                To ease your anxieties, CureCart offers the facility of
          ...
          <Box className="fourthspan">
            <span>Booking a test on CureCart is simple</span>
          </Box>
          ...
          <Box className="pointsdiv1">
            <span>
              ...
              or click on Lab Tests on the CureCart website or app.
            </span>
          </Box>
          <Box className="pointsdiv1">
            <span>
          ...
          <Box className="pathologytestdiv">
            Looking to book a pathology test? Here’s how CureCart can help!
          </Box>
          ...
          <Box className="whychoosepharmEasy">
            Why choose CureCart to book lab tests?
          </Box>

          <Box className="sixthpartdiv">
            We can give you reasons galore for choosing CureCart-
          </Box>
          ...
          <Box className="lastdiv">
            Now that you know why CureCart can be your trusted diagnostic test
            booking partner, don’t wait, download the CureCart app today and
        ...
        <Accordion style={{ margin: "1rem" }} defaultIndex={[0]} allowMultiple>
          <AccordionItem className="acco2">
            <h2>
              <AccordionButton>
                <Box flex="1" textAlign="left">
                  What are the covid precautions CureCart is taking for the
                  testing purpose?
                </Box>
                <AccordionIcon />
              </AccordionButton>
            ...
            <AccordionPanel color={"#8897a2"} pb={4}>
              CureCart takes safety of our patients and staff very seriously.
          ...
          <AccordionItem className="acco2">
            ...
            <AccordionPanel color={"#8897a2"} pb={1}>
              CureCart owns 18 state-of-the-art diagnostic laboratories in the
