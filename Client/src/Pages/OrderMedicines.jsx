          ...
          <Slider {...settings}>
            ...
            <div className={styles.slider_1_div}>
              <div className={styles.slider_1_div_flex}>
                ...
                />
                <p>
                  Get FLAT RS.300 OFF on CureCart
                  <br />
                  Code: CSHB200
                </p>
              </div>
        ...
        <div className={styles.desc}>
          <div>
            ...
            <p>
              ...
              level by the CureCart online medicine delivery app. You can use
              the CureCart online medicine delivery app to browse through an
          ...
          <div>
            ...
            <p>
              ...
              medicines online at CureCart, India’s trusted online medicine
          ...
          <div>
            <Heading s as="h4" size="md">
              Reasons To Buy Medicine Online From CureCart
            </Heading>
            <p>
              Here are a few reasons that will convince you to give online
              medicine order through the CureCart app -
            </p>
            ...
            <li>
              ...
              online purchase through CureCart
            </li>
          </div>
          <div>
            <Heading s as="h4" size="md">
            ...
            <p>
              CureCart is a one-stop-shop for all your healthcare needs. We
          ...
          <Accordion defaultIndex={[0]} allowMultiple>
            <AccordionItem padding="10px">
              ...
              <AccordionPanel pb={4}>
                ...
                products only from licensed retail pharmacies. CureCart is used
            ...
            <AccordionItem padding="10px">
              ...
              <AccordionPanel pb={4}>
                ...
                <li>CureCart Plus subscription with exclusive benefits</li>
            ...
            <AccordionItem padding="10px">
              <h2>
                <AccordionButton>
                  <Box flex="1" textAlign="left">
                    <Heading s as="h3" size="md">
                      When will CureCart deliver my medicines?
                    </Heading>
                  </Box>
                  <AccordionIcon />
                </AccordionButton>
